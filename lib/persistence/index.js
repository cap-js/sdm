...
async function getDraftAttachments(attachments, req) {
  ...
  return await SELECT("up__ID", "createdAt", "createdBy", "modifiedAt", "modifiedBy", "ID", "url", "content",  "mimeType", "filename", "status", "note", "folderId", "IsActiveEntity", "HasDraftEntity", "HasActiveEntity")
