...
module.exports = class SDMAttachmentsService extends (
  ...
  async get(attachments, keys, req) {
    ...
    console.log("Read Res "+(content && typeof content === 'object' && content.status ? content.status : 'undefined'));
       if(content && typeof content === 'object' && content.status == 403){
          req.reject(403, userNotAuthorisedReadError);
       }
       else if(content && typeof content === 'object' && content.status == 404){
