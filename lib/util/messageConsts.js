...
module.exports.mimeTypeInvalidError = 'This file type is not allowed in this repository. Contact your administrator for assistance.';
...
module.exports.attachmentLockedErr = (lockedFiles) => {
  const bulletPoints = lockedFiles.map(file => `• ${file}`).join('\n');
  return `The following attachments are locked and cannot be updated:\n${bulletPoints}\n`;
};
module.exports.lockAttachmentErr = 'Failed to lock the attachment. Please try again or contact your administrator.';
module.exports.unlockAttachmentErr = 'Failed to unlock the attachment. Please try again or contact your administrator.';
module.exports.attachmentAlreadyLockedErr = 'The attachment is already locked.';
module.exports.attachmentNotLockedErr = 'The attachment is not locked.';
